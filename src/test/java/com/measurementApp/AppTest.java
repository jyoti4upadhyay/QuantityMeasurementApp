...
public class AppTest {
	...
	public void convertFeetToInches() {
		Length lengthInInches = App.demonstrateLengthConversion(3.0, LengthUnit.FEET,
				LengthUnit.INCHES);
	...
	public void testCommutativityAddition() {
		...
		Length l1PlusL2 = App.demonstarteLengthAddition(l1, l2, LengthUnit.INCHES);
		Length l2PlusL1 = App.demonstarteLengthAddition(l2, l1, LengthUnit.INCHES);
